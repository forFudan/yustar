...
**宇浩·星陈**是[**宇浩输入法**](http://zhuyuhao.com/yuhao/)的次世代方案，具有强聚类、强音托、弱分区的特点。它完全继承了宇浩输入法的单字拆分和字根设置。同时它和宇浩输入法有以下不同：
...
由于很多字根拼音只有两个字母，首字母容易被占用，故而 15% 情况下会选取其后续字母作为音托。只要特别记住以下字根即可：
